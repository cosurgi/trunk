...
body0.state     = QMPacketGaussianWave(x0=[-1,0,0],t0=0,k0=[k0_x,k0_y,0],a0=[gaussWidth_x,gaussWidth_y,0],gridSize=[16,16]) #,se3=[[0.5,0.5,0.5],Quaternion((1,0,0),0)])
...
body1.state     = QMPacketGaussianWave(x0=[1,0,0],t0=0,k0=[-k0_x,-k0_y,0],a0=[gaussWidth_x,gaussWidth_y,0],gridSize=[16,16]) #,se3=[[0.5,0.5,0.5],Quaternion((1,0,0),0)])
