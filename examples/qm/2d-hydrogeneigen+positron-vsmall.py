...
size1d     = 200
SMALL      = 1
GRIDSIZE   = [2*128/SMALL,2*96/SMALL]
...
potentialCoefficient_positron = [ 0.0000001,0,0]
k0_positron                   = [-0.2,0.0,0.0]
gaussWidth_positron           = [ 10  ,10 ,0  ]
t0_positron                   = 300
x0_positron                   = [150,-90,0]

# wavepacket_2 parameters, electron on stationary orbit
hydrogenEigenFunc_n_electron  = 6
hydrogenEigenFunc_l_electron  = 5
...
body0.state     = QMPacketGaussianWave(x0=x0_positron,t0=t0_positron,k0=k0_positron,a0=gaussWidth_positron,gridSize=[4,4])#GRIDSIZE) #,se3=[[0.5,0.5,0.5],Quaternion((1,0,0),0)])
...
analyticBody.state     = QMPacketHydrogenEigenFunc(t0=65,**coulombPacketArg)
