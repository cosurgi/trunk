...
potentialFileName    = "1d-harmonic-eigen-wavefunction-FromFile-test-0.001.txt"
# observe larger error when potential is less precise
#potentialFileName    = "1d-harmonic-eigen-wavefunction-FromFile-test-0.050.txt"
#potentialFileName    = "1d-harmonic-eigen-wavefunction-FromFile-test-0.100.txt"
potentialColumnX     = 1
...
potentialBody.material  = QMParametersFromFile(  dim=dimensions,hbar=1 #,coefficient=potentialCoefficient
                                                ,filename=potentialFileName,columnX=potentialColumnX,columnVal=potentialColumnVal)
...
try:
	...
	qt.View()
	qt.Controller()
	qt.controller.setWindowTitle("Same as 1d-harmonic-eigen-wavefunction.py, but potential is loaded from file")
