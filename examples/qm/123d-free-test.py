...
gaussPacket1            = FreeMovingGaussianWavePacket(dim=1,x0=[0,0,0],t0=0,k0=[3,0,0],m=1,a=[1,0,0],hbar=1)
...
gaussPacket2            = FreeMovingGaussianWavePacket(dim=2,x0=[0,0,0],t0=0,k0=[3,0,0],m=1,a=[1,1,0],hbar=1)
...
gaussPacket3            = FreeMovingGaussianWavePacket(dim=3,x0=[0,0,0],t0=0,k0=[3,0,0],m=1,a=[1,1,1],hbar=1)
