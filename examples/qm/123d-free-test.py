...
analyticBody1.shape     = QMGeometry(extents=halfSize1,color=[0.6,0.6,0.6],displayOptions=[QMDisplayOptions(
...
gaussPacket1            = QMPacketGaussianWave(x0=[6,0,0],t0=0,k0=[3,0,0],a0=[1,0,0],gridSize=[2**9])
analyticBody1.state     = gaussPacket1
O.bodies.append(analyticBody1)

analyticBody2           = QMBody()
analyticBody2.groupMask = 4
analyticBody2.shape     = QMGeometry(extents=halfSize2,color=[0.8,0.8,0.8],displayOptions=[QMDisplayOptions(
                                   partAbsolute=['default hidden', 'hidden', 'nodes', 'points', 'wire', 'surface']
                                  ,partImaginary=['default hidden', 'hidden', 'nodes', 'points', 'wire', 'surface']
                                  ,partReal=['default surface', 'hidden', 'nodes', 'points', 'wire', 'surface']
                                  ,step=[0.2,0.2,0.2]
...
gaussPacket2            = QMPacketGaussianWave(x0=[6,0,0],t0=0,k0=[3,0,0],a0=[1,1,0],gridSize=[2**7]*2)
...
analyticBody3.shape     = QMGeometry(extents=halfSize3,color=[1.0,1.0,1.0],displayOptions=[QMDisplayOptions(
                                   partAbsolute=['default hidden', 'hidden', 'nodes', 'points', 'wire', 'surface']
                                  ,partImaginary=['default hidden', 'hidden', 'nodes', 'points', 'wire', 'surface']
                                  ,partReal=['default surface', 'hidden', 'nodes', 'points', 'wire', 'surface']
                                  ,step=[0.2,0.2,0.2]
...
gaussPacket3            = QMPacketGaussianWave(x0=[6,0,0],t0=0,k0=[3,0,0],a0=[1,1,1],gridSize=[32]*3)
